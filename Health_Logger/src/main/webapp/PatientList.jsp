...
<body>
		...
		<c:out
			...
			<form action="SearchPatients.jsp" method="post">
				<button type="submit" id="search-btn">
					<span style="margin-right: 5px;">Search Patient</span> <span
						style="font-weight: bold;">&rarr;</span>
				</button>
			</form>
			...
			<form action="ViewAllVitalServlet">
				<button type="submit" id="manage-vitals-btn">
	...
	<table>
		...
		<tbody>
			<c:forEach var="patient" items="${sessionScope.patientsList}">
				<tr>
